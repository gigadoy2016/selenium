...
def main():
	...
	chrome_driver_path = "D:\\12_Preparation\\calories\scrapping\\chromedriver_91\\chromedriver.exe"  
	browser_path = "C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe" 
	#browser_path = "D:\\12_Preparation\\calories\\scrapping\\chromedriver_91\\chrome.exe" 
	...
	for img in imges:
		...
		try:
			...
			f = open(download_path+searchtext.replace(" ", "_")+"/"+str(downloaded_img_count)+"."+img_type[1], "wb")
			f.write(raw_img)
			f.close
